...
* **Вкладка «Настройки» (Settings):**  
  Управление портом DSU (`26760`), выбор сетевого интерфейса, поведение при закрытии окна (сворачивание в трей с ультранизким потреблением ОЗУ) и переключение языка.
